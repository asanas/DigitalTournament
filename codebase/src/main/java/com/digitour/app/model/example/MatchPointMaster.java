...
public class MatchPointMaster implements java.io.Serializable {
    ...
    @JoinColumn(name="matchPointId", referencedColumnName="symbol_id")
    ...
    @ManyToOne(optional=false)
    @JoinColumn(name="matchPointId", referencedColumnName="tournament_match_id")
	...
	@ManyToOne(optional=false)
    @JoinColumn(name="matchPointId", referencedColumnName="tour_p_t_id")
