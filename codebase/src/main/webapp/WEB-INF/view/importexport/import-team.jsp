    ...
    <div class="container">
        ...
        <form class="form-horizontal" role="form" method="POST" action="${pageContext.request.contextPath}/createnew/team" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <div class="col-lg-6 text-left" >
                    <label class="radio-inline"><input type="radio" name="gender" value="Male">Men</label>
                    <label class="radio-inline"><input type="radio" name="gender" value="Female">Women</label>
                </div>
            </div>
            <div class="form-group">
