<%@include file="../common/common-taglibs.jsp"%>
    <div class="modal-dialog modal-lg">
        <!-- Modal content-->
        <div class="${modalClass } modal-content ">
            ...
            <div class="modal-body">
                ...
                <div class="row">
                    <div class="col-lg-4 text-center"><h3 style="margin-left: 140px;">${team1Score }</h3></div>
                    <div class="col-lg-4 text-center">
                        <c:if test="${isHalfTimeCompleted }">
                            <h4 style="margin-bottom: 0; ">Half Time</h4>(${ team1HalfTimeScore }- ${ team2HalfTimeScore })
                        </c:if>
                        </div>
                    <div class="col-lg-4 text-center"><h3 style="margin-right: 140px;">${team2Score }</h3></div>
                </div>
                <div class="row">
